...
export class SchemaService {
  ...
  public static propertyToSelectString(prop: SchemaEntityProperty): string {
    ...
    return (prop.type == EntityPropertyType.User) ? prop.column_name + ':civic_os_users!' + prop.column_name + '(id,display_name,private:civic_os_users_private(display_name,phone,email))' :
