...
ALTER TABLE IF EXISTS public.civic_os_users
...
ALTER TABLE IF EXISTS public.civic_os_users_private
    OWNER to postgres;
...
CREATE TRIGGER on_update_sync_contact_information
    ...
    ON auth.users
    FOR EACH ROW
    EXECUTE FUNCTION public.create_or_update_contact_from_user();
